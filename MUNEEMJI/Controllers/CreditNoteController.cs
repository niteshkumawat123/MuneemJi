...
namespace MUNEEMJI.Controllers
{
    public class CreditNoteController:Controller
    {
        ...
        public CreditNoteController(ICreditNoteRepository billService, IWebHostEnvironment environment, IBillItemService iBillItemService, ICompanyTenancy compayTenancy, IParty partyController)
        {
