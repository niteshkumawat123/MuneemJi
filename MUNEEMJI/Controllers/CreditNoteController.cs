...
namespace MUNEEMJI.Controllers
{
    ...
    {
        private readonly ICreditNoteRepository _billService;
        ...
        public CreditNoteController(ICreditNoteRepository billService, IWebHostEnvironment environment, IBillItemService iBillItemService, ICompanyTenancy compayTenancy, IParty partyController, IGstTaxService gstTaxService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ";
                ...
                List<PurchaseBill> PurchaseList = connection.QuerySql<PurchaseBill>(query, new 
                { TradeDocumentTypesid = (int)TradeDocumentTypes.CreditNote , p_companyid = companyId }).ToList();
