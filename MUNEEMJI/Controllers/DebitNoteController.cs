...
namespace MUNEEMJI.Controllers
{
    ...
    public class DebitNoteController : Controller
    {
        ...
        public DebitNoteController(IDebitNoteRepository billService, IWebHostEnvironment environment, IBillItemService iBillItemService, ICompanyTenancy compayTenancy, IParty partyController, IGstTaxService gstTaxService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                var PurchaseBill = connection.QuerySql<PurchaseBill>(query, new {
                    TradeDocumentTypesid = (int)TradeDocumentTypes.DebitNote ,
