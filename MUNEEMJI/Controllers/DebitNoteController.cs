...
namespace MUNEEMJI.Controllers
{
    ...
    public class DebitNoteController : Controller
    {
        ...
        public DebitNoteController(IDebitNoteRepository billService, IWebHostEnvironment environment, IBillItemService iBillItemService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ";
                ...
                List<PurchaseBill> PurchaseList = connection.QuerySql<PurchaseBill>(query, new { TradeDocumentTypesid = (int)TradeDocumentTypes.DebitNote }).ToList();
