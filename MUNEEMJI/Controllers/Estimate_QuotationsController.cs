...
{
    public class Estimate_QuotationsController:Controller
    {
        private readonly IDebitNoteRepository _billService;
        ...
        public Estimate_QuotationsController(IDebitNoteRepository billService, IWebHostEnvironment environment, IBillItemService iBillItemService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ";
                ...
                List<PurchaseBill> PurchaseList = connection.QuerySql<PurchaseBill>(query, new { TradeDocumentTypesid = (int)TradeDocumentTypes.Estimation }).ToList();
