...
namespace MUNEEMJI.Controllers
{
    ...
    //{
    //    new ItemDropdownModel { ItemId = 1, Name = "Item A" },
    //    new ItemDropdownModel { ItemId = 2, Name = "Item B" }
    //};

    //    private List<UnitModel> GetDummyUnits() => new()
    //{
    //    new UnitModel { UnitId = 1, Name = "PCS" },
    //    new UnitModel { UnitId = 2, Name = "BOX" }
    //};

    //    private List<TaxModel> GetDummyTaxes() => new()
    //{
    //    new TaxModel { TaxId = 1, Name = "GST 18%" },
    //    new TaxModel { TaxId = 2, Name = "GST 5%" }
    //};
