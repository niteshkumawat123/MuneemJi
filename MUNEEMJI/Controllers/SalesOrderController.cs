...
namespace MUNEEMJI.Controllers
{
    ...
    {
        private readonly ISalesOrderService _billService;
        ...
        public SalesOrderController(ISalesOrderService billService, IWebHostEnvironment environment, IBillItemService iBillItemService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ";
                ...
                List<PurchaseBill> PurchaseList = connection.QuerySql<PurchaseBill>(query, new { TradeDocumentTypesid = (int)TradeDocumentTypes.SalesOrder }).ToList();
