...
namespace MUNEEMJI.Repositories
{
    ...
    public class DebitNoteRepository: IDebitNoteRepository
    {
        ...
        public DebitNoteRepository(IConfiguration configuration)
        {
...
INSERT INTO TradeDocuments (bill_number, bill_date, stateid, state_of_supply, phone_no, po_no, po_date, 
                 ...
                 tdstcs_amount, isroundoff, final_amount,isreceive,ReturnNo,Companyid)
VALUES (@BillNumber, @BillDate, @StateId, @StateOfSupply, @PhoneNo, @PONo, @PODate, 
       ...
       @TdsTcsAmount, @IsRoundOff, @FinalAmount,@isreceive,@p_ReturnNo,@p_companyid)
RETURNING id";
                ...
                billCommand.Parameters.AddWithValue("@TradeDocumentTypesId", (int)TradeDocumentTypes.DebitNote);
                ...
                billCommand.Parameters.AddWithValue("@p_ReturnNo", bill.ReturnNo);
